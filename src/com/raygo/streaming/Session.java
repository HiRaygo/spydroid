...
import com.raygo.streaming.audio.AudioStream;
import com.raygo.streaming.exceptions.CameraInUseException;
import com.raygo.streaming.exceptions.ConfNotSupportedException;
import com.raygo.streaming.exceptions.InvalidSurfaceException;
import com.raygo.streaming.exceptions.StorageUnavailableException;
import com.raygo.streaming.gl.SurfaceView;
import com.raygo.streaming.rtsp.RtspClient;
import com.raygo.streaming.video.VideoQuality;
import com.raygo.streaming.video.VideoStream;
...
public class Session {
	...
	static {
		...
		new HandlerThread("com.raygo.streaming.Session"){
			@Override
