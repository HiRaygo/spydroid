...
import com.raygo.streaming.rtp.AbstractPacketizer;
...
public abstract class MediaStream implements Stream {
	 ...
	 * {@link VideoStream#setVideoQuality(com.raygo.streaming.video.VideoQuality)}
	 * for a {@link VideoStream} and {@link AudioStream#setAudioQuality(com.raygo.streaming.audio.AudioQuality)}
	...
	/**
	 * Returns the SSRC of the underlying {@link com.raygo.streaming.rtp.RtpSocket}.
	...
	protected void createSockets() throws IOException {
		...
		final String LOCAL_ADDR = "com.raygo.streaming-";
